          ...
          <div className="relative z-10 grid md:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <div className="reveal d3 flex flex-col gap-4">
                <a
                  href="mailto:jonathan.j.troiano@gmail.com"
                ...
                <a
                  href="https://github.com/jjtroiano0272"
                  rel="noopener noreferrer"
                  target="_blank"
                  className="group flex items-center gap-3 text-zinc-400 hover:text-white transition-colors"
                >
            ...
            <div className="reveal d2">
              <form action="#" method="POST" noValidate>
                <div className="flex flex-col gap-4">
                  ...
                  <button
                    type="submit"
                    className="shimmer w-full bg-accent text-white font-display font-bold text-sm py-3.5 rounded-xl hover:bg-accent-light transition-colors cursor-pointer"
                  >
                    Send message →
                  </button>
                </div>
